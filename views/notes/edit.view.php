                ...
                <div class="col-span-3">
                    <form  method="POST" action="/note/update">
                        ...
                        <div class="mt-2">
                            ...
                            ><?= isset($post['title']) ? $post['title'] : $post ?></textarea>
                        </div>
                        <div class="flex justify-between">
                            <p class="mt-5 text-sm/6 text-gray-600">Write a note by yourself.</p>
                            <div class="flex gap-x-4">
                                <button
                                        class="bg-blue-600 outline hover:outline-blue-600 hover:outline-offset-2 hover:outline-2 hover:bg-blue-700 w-20 text-white mt-3 rounded-full p-2"
