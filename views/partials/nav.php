            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/"
                           class="rounded-md <?= urlIs("/") ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" ?> px-3 py-2 text-sm font-medium "
                    ...
                    <div class="relative ml-3">
                        <div>
                            <button type="button"
                                ...
                                <?php else : ?>
                                    <a class="text-white p-2" href="/register">Register</a>
                                    <a class="text-white p-2" href="/login">Login</a>
                                <?php endif ?>
